...
options.add_argument(
    "user-data-dir=C:\\Users\\Asus\\AppData\\Local\\Google\\Chrome Beta\\User Data\\"
)
options.binary_location = (
    "C:\\Program Files\\Google\\Chrome Beta\\Application\\chrome.exe"
)
chromedriver_path = "C:\\Program Files\\chromedriver-win64\\chromedriver.exe"  # Update this path if needed
...
if int(answer) == 1:
    ...
    for i in range(int(howmany)):
        ...
        for _ in range(3):  # Use _ instead of i to avoid shadowing
            next_button.click()
            time.sleep(1)
